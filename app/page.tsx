...
const MobileOptimizedPassportGenerator = dynamicImport(
  () => import('@/components/mobile-optimized-passport-generator').then(mod => ({ default: mod.MobileOptimizedPassportGenerator })),
  {
    ssr: false,
    loading: () => (
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6 md:space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mt-8 md:mt-12 animate-fade-in-up px-4">
            <div className="group p-4 md:p-6 bg-white/80 dark:bg-gray-900/80 rounded-xl backdrop-blur-md border border-purple-200/50 dark:border-purple-800/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="font-semibold mb-2 text-base md:text-lg">Real Data</h3>
            ...
            <div className="group p-4 md:p-6 bg-white/80 dark:bg-gray-900/80 rounded-xl backdrop-blur-md border border-blue-200/50 dark:border-blue-800/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="text-3xl md:text-4xl mb-3 group-hover:scale-110 transition-transform duration-300">⚡</div>
              <h3 className="font-semibold mb-2 text-base md:text-lg">Instant Mint</h3>
              <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
                Generate and mint your passport NFT on Base network in seconds
              </p>
            </div>
            <div className="group p-4 md:p-6 bg-white/80 dark:bg-gray-900/80 rounded-xl backdrop-blur-md border border-pink-200/50 dark:border-pink-800/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 sm:col-span-2 md:col-span-1">
              <div className="text-3xl md:text-4xl mb-3 group-hover:scale-110 transition-transform duration-300">🔗</div>
              <h3 className="font-semibold mb-2 text-base md:text-lg">Shareable</h3>
              <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="mt-12 md:mt-16 animate-fade-in-up px-4">
            <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-md rounded-2xl border border-purple-200/50 dark:border-purple-800/50 shadow-2xl overflow-hidden">
              <div className="bg-gradient-to-r from-purple-600 to-blue-600 p-4 md:p-6">
                <h2 className="text-xl md:text-2xl font-bold text-white mb-2">About Me</h2>
                <p className="text-purple-100 text-sm md:text-base">Meet the creator behind this passport builder</p>
              </div>
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4 md:gap-6">
                  ...
                  <div className="flex-1 text-left w-full">
                    ...
                    <div className="flex flex-wrap gap-2 md:gap-3 mb-4">
                      ...
                      <span className="px-2 md:px-3 py-1 bg-pink-100 dark:bg-pink-900/50 text-pink-700 dark:text-pink-300 rounded-full text-xs md:text-sm font-medium">
                        🎯 Farcaster
                      </span>
                    </div>
