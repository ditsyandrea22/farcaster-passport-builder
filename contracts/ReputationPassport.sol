 ...
 * @dev ERC721 NFT representing Farcaster user reputation with mint fee
 */
contract ReputationPassport is ERC721, Ownable {
    uint256 public nextTokenId;
    string public baseTokenURI;
    
    // Mint fee of 0.0002 ETH
    ...
    /**
     * @dev Mint a new reputation passport with fee
    ...
    function mintPassport(
        ...
        // Send mint fee to contract owner
        if (msg.value > 0) {
